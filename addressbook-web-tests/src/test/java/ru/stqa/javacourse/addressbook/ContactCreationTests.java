...
public class ContactCreationTests {
  ...
  public void testContactCreationTests() throws Exception {
    ...
    wd.findElement(By.name("firstname")).sendKeys("Petrov");
    wd.findElement(By.name("middlename")).clear();
    wd.findElement(By.name("middlename")).sendKeys("Ivanov");
    wd.findElement(By.name("lastname")).clear();
    wd.findElement(By.name("lastname")).sendKeys("Sidorov");
    wd.findElement(By.name("nickname")).clear();
    wd.findElement(By.name("nickname")).sendKeys("IPS");
    ...
    wd.findElement(By.name("home")).sendKeys("+73831234578");
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys("+71234567890");
